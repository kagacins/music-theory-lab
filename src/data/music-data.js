...
const CHORD_DEFINITIONS = {
    ...
    'Suspended 2nd': { intervals: [0, 2, 7], symbol: 'sus2', description: 'Replaces the 3rd of a major triad with a Major 2nd (Root, Major 2nd, Perfect 5th). The 3rd is removed and replaced, creating an open, unresolved sound.' },
    'Suspended 4th': { intervals: [0, 5, 7], symbol: 'sus4', description: 'Replaces the 3rd of a major triad with a Perfect 4th (Root, Perfect 4th, Perfect 5th). The 3rd is removed and replaced, creating tension that wants to resolve.' },
