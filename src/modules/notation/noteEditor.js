...
export class NoteEditor {
  ...
  findClosestNoteWithinProximity(x, y) {
    ...
    // These are tuned to feel natural - not too far that wrong notes get selected
    const MAX_X_DISTANCE = 40;  // ~40px horizontal (roughly a note width)
    const MAX_Y_DISTANCE = 25;  // ~25px vertical (allows some staff line tolerance)
