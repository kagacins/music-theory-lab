...
function renderSimplifiedChordSequence(container, progressionData, key, options = {}) {
    ...
    if (showActionButtons) {
        ...
        const containerId = container.id || 'melody-progression-visualization';
        buttonContainer.innerHTML = `
            ...
            <button onclick="window.showSongBuilderModal && window.showSongBuilderModal()"
                    class="w-full px-3 py-2 bg-blue-500 hover:bg-blue-600 text-white text-xs font-semibold rounded-lg shadow transition flex items-center justify-center gap-1.5"
...
function createActionButtonsToolbar(containerId) {
    ...
    toolbar.innerHTML = `
        ...
        <button onclick="window.showSongBuilderModal && window.showSongBuilderModal()"
                class="px-3 py-1.5 bg-blue-500 hover:bg-blue-600 text-white text-xs font-semibold rounded-lg shadow transition flex items-center gap-1.5"
                title="Open Song Builder to organize sections">
            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
function createSectionToolbar(containerId) {
    ...
    toolbar.innerHTML = `
        <button class="add-section-btn flex items-center gap-1 px-3 py-1.5 bg-purple-500 hover:bg-purple-600 text-white text-xs font-medium rounded-md transition"
