...
export function renderRecommendationItem(recommendation, index = -1) {
    ...
    item.innerHTML = `
        ...
        <div class="chord-score">
            <button class="chord-why-btn"
                    data-chord-root="${recommendation.chord.root}"
                    data-chord-type="${recommendation.chord.type}"
                    data-chord-inversion="${inversion}"
                    data-chord-function="${recommendation.function || ''}"
                    data-chord-score="${Math.round(recommendation.totalScore)}"
                    title="Why does this chord work here?">
